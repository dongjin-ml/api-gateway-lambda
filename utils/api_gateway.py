...
class api_gateway_handler():
    ...
    def _create_rest_api(self, api_name, api_description, api_base_path, api_stage, account_id, lambda_function_arn):
        ...
        try:
            ...
            logger.exception("Couldn't replace stages")
            raise
    ...
    def _delete_rest_api(self, api_id):
        """
        ...
        try:
            ...
            print (f"  api-gateway: [{api_id}] is deleted successfully")
        except ClientError:
